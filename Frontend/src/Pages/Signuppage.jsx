...
export default function SignUpPage() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      setLoading(true);
      const res = await axios.post("http://localhost:5000/auth/api/signup", {
        name,
        email,
        password,
      });
  ...
  return (
    <div className="min-h-screen bg-[#1a1a1a] flex">
        ...
        <div className="flex flex-1 items-center justify-center px-8">
          <div className="flex flex-col gap-6 w-full max-w-[340px]">
            ...
            <div className="flex flex-col gap-3">
              ...
              <div>
                <h1 className="text-[#e8e8e8] text-2xl font-semibold tracking-tight">Create your account</h1>
            ...
            <div className="flex flex-col gap-3">
              <div className="flex flex-col gap-1.5">
                <label className="text-[#888] text-xs font-medium">Full name</label>
                <input
                  type="text"
              ...
              <div className="flex flex-col gap-1.5">
                <label className="text-[#888] text-xs font-medium">Email address</label>
                <input
                  type="email"
              ...
              <div className="flex flex-col gap-1.5">
                <label className="text-[#888] text-xs font-medium">Password</label>
                <input
                  type="password"
            ...
            <p className="text-[#3d3d3d] text-xs leading-relaxed text-center">
              ...
              <a href="/terms" className="text-[#555] hover:text-[#888] underline underline-offset-2 transition-colors">Terms</a>{" "}
              and{" "}
              <a href="/privacy" className="text-[#555] hover:text-[#888] underline underline-offset-2 transition-colors">Privacy Policy</a>.
            </p>

            <p className="text-[#555] text-sm text-center">
              Already have an account?{" "}
              <a href="/login" className="text-orange-400 hover:text-orange-300 font-medium transition-colors">Log in</a>
            </p>
      ...
      {/* RIGHT PANEL — same as before, unchanged */}
      <div className="hidden lg:flex lg:w-1/2 bg-[#161616] border-l border-white/6 flex-col items-center justify-center relative overflow-hidden gap-6 p-10">
        {/* ... right panel ka code same rehta hai ... */}
      </div>
